  ...
  <section class="page-shell list-page">
    <div class="page-card list-card">
      ...
      <div class="table-shell table-shell--fill">
        ...
        <el-table-column prop="activityWeight" label="活跃度权重" width="100" />
        <el-table-column prop="sampleSizeWeight" label="样本权重" width="100" />
        <el-table-column prop="positionWeightMode" label="仓位模式" width="100" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.ruleId ? '编辑规则' : '新增规则'" width="560px">
      <el-form :model="form" label-width="120px">
        <el-form-item label="规则名称"><el-input v-model="form.ruleName" /></el-form-item>
        <el-form-item label="收益权重"><el-input-number v-model="form.returnWeight" :precision="2" :step="0.05" :min="0" /></el-form-item>
        <el-form-item label="胜率权重"><el-input-number v-model="form.winRateWeight" :precision="2" :step="0.05" :min="0" /></el-form-item>
        <el-form-item label="回撤惩罚"><el-input-number v-model="form.drawdownWeight" :precision="2" :step="0.05" :min="0" /></el-form-item>
        <el-form-item label="活跃度权重"><el-input-number v-model="form.activityWeight" :precision="2" :step="0.05" :min="0" /></el-form-item>
        <el-form-item label="样本数权重"><el-input-number v-model="form.sampleSizeWeight" :precision="2" :step="0.05" :min="0" /></el-form-item>
        ...
        <el-form-item label="衰减天数"><el-input-number v-model="form.decayDays" :min="1" /></el-form-item>
        <el-form-item label="大V权重上限"><el-input-number v-model="form.maxAuthorWeight" :precision="2" :step="0.1" :min="0.1" /></el-form-item>
        <el-form-item label="最小样本数"><el-input-number v-model="form.minSampleCount" :min="1" /></el-form-item>
