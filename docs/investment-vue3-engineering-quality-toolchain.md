...
其中 `docs/backup` 被忽略，是因为它是备份文档目录，不应该因为历史备份文件格式不同而影响工程检查结果。
...
- [docs/investment-vue3-engineering-quality-toolchain.md](/mnt/d/develop/source/investment-vue3/docs/investment-vue3-engineering-quality-toolchain.md)
